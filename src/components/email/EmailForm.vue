...
<template>
  <div class="email-form">
    ...
    <!-- AI 编辑器弹窗 -->
    <div v-if="showAiEditor" class="ai-editor-overlay" @click.self="showAiEditor = false">
      <div class="ai-editor-modal">
        <!-- 头部 -->
        <div class="editor-header">
          <h3>📝 AI 文本编辑器</h3>
          <button class="close-btn" @click="showAiEditor = false">×</button>
        </div>
        ...
        <div class="editor-footer">
          <button class="cancel-btn" @click="showAiEditor = false">取消</button>
          <button class="confirm-btn" @click="handleAiConfirm('')">
            ✅ 确认使用
          </button>
        </div>
      </div>
